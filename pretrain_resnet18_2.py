...
class RandomMotionBlur:
    """Applies a simple motion blur approximation using GaussianBlur."""
    ...
    def __call__(self,img):
        ...
        return img.filter(ImageFilter.GaussianBlur(radius=k//5))
...
if __name__ == "__main__":
    ...
    save_path = "/home/hlcv_team038/pretrained_models/resnet18_simclr_kitti.pth"
